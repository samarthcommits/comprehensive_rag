...
# from ann_retrieval import ANN
# from query_expansion_retrieval import QExpansion_retriever
# obj = SparseRetriever(collection_name='collect1', user_name='samarth1')
from pymilvus import utility, connections, Collection, db

conn = connections.connect(host="127.0.0.1", port="19530")
list1 = db.list_database()
# print(utility.list_collections())
for i in list1:
    print(i, '-')
    conn = connections.connect(db_name=i, host="127.0.0.1", port="19530")
    print(utility.list_collections())


# from sparse_retrieval import SparseRetriever_milvus

# # res = obj.invoke(query='Travel and exploration captured the imagination')
...
# check = SparseRetriever_milvus(collection_name='some1some', user_name='samarth2')
# # check.add_documents_to_db(raw_text=text)
# print(check.invoke_sparse('Travel and exploration'))
